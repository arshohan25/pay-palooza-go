...
You need to manually clear it in your browser: open the preview, open DevTools → Application → Local Storage, and delete `mfs_user_name`, `mfs_registered_phone`, and `mfs_display_photo`. Then refresh.
