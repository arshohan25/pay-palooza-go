    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      {product.merchants?.user_id !== user?.id && (
        <button
          ...
          className="fixed bottom-20 right-4 z-[60] w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center hover:bg-primary/90 active:scale-95 transition-all disabled:opacity-60"
