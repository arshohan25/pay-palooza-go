...
const translations = {
  ...
  deductedFromAmount: { en: "Deducted from amount", bn: "পরিমাণ থেকে কাটা" },
  ...
  sentTo: { en: "sent to", bn: "পাঠানো হয়েছে" },
  ...
  slideToSendMoney: { en: "Slide to Send Money", bn: "টাকা পাঠাতে স্লাইড করুন" },
  cashOutAmount: { en: "Cash Out Amount", bn: "ক্যাশ আউট পরিমাণ" },
  cashingOutAt: { en: "Cashing out at", bn: "ক্যাশ আউট করা হচ্ছে" },
  transferringTo: { en: "Transferring to", bn: "ট্রান্সফার করা হচ্ছে" },
  ...
  accountHolder: { en: "Account Holder", bn: "অ্যাকাউন্ট ধারক" },
  youReceived: { en: "You Received", bn: "আপনি পেয়েছেন" },
  paymentSuccessful: { en: "Payment Successful!", bn: "পেমেন্ট সফল!" },
  paidTo: { en: "paid to", bn: "পরিশোধ করা হয়েছে" },
  category: { en: "Category", bn: "শ্রেণী" },
  note: { en: "Note", bn: "নোট" },
  confirmWithPin: { en: "Confirm with PIN", bn: "পিন দিয়ে নিশ্চিত করুন" },
  enterWalletPin: { en: "Enter your 4-digit wallet PIN to complete", bn: "সম্পূর্ণ করতে আপনার ৪ সংখ্যার ওয়ালেট পিন দিন" },
  adding: { en: "Adding", bn: "যোগ হচ্ছে" },
  source: { en: "Source", bn: "সোর্স" },
  walletCredit: { en: "Wallet Credit", bn: "ওয়ালেট ক্রেডিট" },
  moneyAdded: { en: "Money Added!", bn: "টাকা যোগ হয়েছে!" },
  addedToWallet: { en: "has been added to your wallet", bn: "আপনার ওয়ালেটে যোগ হয়েছে" },
  transactionReceipt: { en: "Transaction Receipt", bn: "লেনদেন রসিদ" },
  iSentTransfer: { en: "I've Sent the Transfer", bn: "আমি ট্রান্সফার পাঠিয়েছি" },
  rechargeSuccessful: { en: "Recharge Successful!", bn: "রিচার্জ সফল!" },
  browseByOperator: { en: "Browse by operator", bn: "অপারেটর অনুসারে ব্রাউজ করুন" },
  detectedOperator: { en: "Detected operator", bn: "শনাক্ত করা অপারেটর" },
  unknownOperator: { en: "Unknown operator", bn: "অজানা অপারেটর" },
  recharging: { en: "Recharging", bn: "রিচার্জ হচ্ছে" },
  authorizeRecharge: { en: "Authorize this recharge", bn: "এই রিচার্জ অনুমোদন করুন" },
  deductedFromBalance: { en: "Deducted from balance", bn: "ব্যালেন্স থেকে কাটা হয়েছে" },
