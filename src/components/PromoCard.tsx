...
const PromoCard = () => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-[19px] gradient-accent shadow-card press-effect cursor-pointer group" shadow-card press-effect cursor-pointer group"
    >
      {/* Decorative blobs */}
