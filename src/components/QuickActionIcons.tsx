...
export const SendMoneyIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
    ...
    {/* Arrow tip */}
    <path d="M42 28 L37 24 M42 28 L37 32" stroke="#E91E8C" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const CashOutIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
    {/* Hand holding cash bills */}
    {/* Bill stack */}
...
export const PaymentIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
    ...
    {/* scan line */}
    <line x1="10" y1="28" x2="46" y2="28" stroke="#CE93D8" strokeWidth="1.5" strokeLinecap="round" opacity="0.7"/>
  </svg>
);
...
export const PayBillIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
    ...
    {/* Bolt inside */}
    <path d="M30 18 L26 25 L29 25 L26 32 L32 23 L29 23 Z" fill="white" opacity="0.9"/>
  </svg>
);
