              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border text-muted-foreground">
                    ...
                    <th className="text-left px-4 py-3 font-medium hidden md:table-cell">Receiver</th>
                              ...
                              <td colSpan={11} className="p-0">
                                ...
                                >
                                  <div className="bg-muted/30 px-6 py-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                                    ...
                                    <div>
                                      <p className="text-muted-foreground text-xs mb-1">Short ID</p>
                                      <p className="font-mono text-foreground">{txn.short_id}</p>
                                    </div>
                                    <div>
                                      <p className="text-muted-foreground text-xs mb-1">Sender</p>
                                      <p className="text-foreground">{sender?.name || "—"}</p>
                                    ...
                                    <div>
                                      ...
                                      <p className="text-foreground">{txn.recipient_name || "—"}</p>
                                      <p className="text-xs text-muted-foreground">{txn.recipient_phone || "—"}</p>
                                    </div>
                                    <div>
                                      <p className="text-muted-foreground text-xs mb-1">Amount / Fee / Commission</p>
                                      <p className="text-foreground">
                                        ৳{txn.amount?.toLocaleString()} / ৳{txn.fee?.toLocaleString()} / ৳{txn.commission?.toLocaleString()}
                                      </p>
                                    </div>
                                    <div>
