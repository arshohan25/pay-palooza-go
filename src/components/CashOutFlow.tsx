...
const CashOutFlow = ({ onClose }: CashOutFlowProps) => {
  ...
  // Fee: 1.85% of amount (standard cash-out rate)
  const fee = parseFloat(amount) > 0 ? (parseFloat(amount) * 0.0185).toFixed(2) : "0.00";
  const receive = parseFloat(amount) > 0 ? (parseFloat(amount) - parseFloat(fee)).toFixed(2) : "0.00";
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-9 h-12 text-base bg-card border-border uppercase"
                    />
                  </div>
                  {error && (
