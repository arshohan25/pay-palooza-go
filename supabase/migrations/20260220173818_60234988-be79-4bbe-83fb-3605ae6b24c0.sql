...
-- Add commission column to transactions
ALTER TABLE public.transactions ADD COLUMN commission numeric NOT NULL DEFAULT 0;

-- Update transfer_money to support commission for agents
...
BEGIN
  ...
  IF v_recipient_profile.user_id IS NOT NULL THEN
    -- Credit recipient with amount + commission
