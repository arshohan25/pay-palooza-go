...
CREATE OR REPLACE FUNCTION public.buy_gold(p_grams NUMERIC, p_price_per_gram NUMERIC, p_karat TEXT DEFAULT '22K', p_pin TEXT DEFAULT NULL)
...
CREATE OR REPLACE FUNCTION public.sell_gold(p_grams NUMERIC, p_price_per_gram NUMERIC, p_karat TEXT DEFAULT '22K', p_pin TEXT DEFAULT NULL)
RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION public.buy_stock(p_symbol TEXT, p_name TEXT, p_quantity INTEGER, p_price NUMERIC, p_pin TEXT DEFAULT NULL)
RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
DECLARE
